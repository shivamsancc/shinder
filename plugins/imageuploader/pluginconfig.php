...
$username = "admin"; $password = '21232f297a57a5a743894a0e4a801fc3';
    ...
    $useruploadfolder = "citet/assets/images/noticeupload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "citet/assets/images/noticeupload";
        

    $useruploadfolder = "citet/assests/images/noticeupload";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "citet/assests/images/noticeupload";
        

    $useruploadfolder = "whatsview/assets/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "whatsview/assets/uploads";
